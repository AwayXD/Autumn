...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (custompanoramaproperties != null)
        {
            j = custompanoramaproperties.getOverlay1Top();
            k = custompanoramaproperties.getOverlay1Bottom();
            l = custompanoramaproperties.getOverlay2Top();
            i1 = custompanoramaproperties.getOverlay2Bottom();
        }

        this.drawGradientRect(0, 0, this.width, this.height, j, k);
        ...
        {
            this.drawTexturedModalRect(i + 0, b0 + 0, 0, 0, 99, 44);
            this.drawTexturedModalRect(i + 99, b0 + 0, 129, 0, 27, 44);
            this.drawTexturedModalRect(i + 99 + 26, b0 + 0, 126, 0, 3, 44);
            this.drawTexturedModalRect(i + 99 + 26 + 3, b0 + 0, 99, 0, 26, 44);
            this.drawTexturedModalRect(i + 155, b0 + 0, 0, 45, 155, 44);
        }
        else
        {
            this.drawTexturedModalRect(i + 0, b0 + 0, 0, 0, 155, 44);
            this.drawTexturedModalRect(i + 155, b0 + 0, 0, 45, 155, 44);
        }
        ...
        if (Reflector.FMLCommonHandler_getBrandings.exists())
        {
            ...
            for (int j1 = 0; j1 < list.size(); ++j1)
            {
                ...
                {
                    this.drawString(this.fontRendererObj, s1, 2, this.height - (10 + j1 * (this.fontRendererObj.FONT_HEIGHT + 1)), 16777215);
                }
            }
